...
describe('TaskList', () => {
  ...
  it('affiche le badge Décalée si la tâche est auto-décalée', () => {
    render(<TaskList tasks={[{ ...baseTask, estimated_time: 30, start_time: '2024-06-01T11:00:00.000Z' }]} />);
  ...
  it('a un aria-label sur la checkbox', () => {
    render(<TaskList tasks={[baseTask]} />);
    expect(screen.getByLabelText(/marquer la tâche/i)).toBeInTheDocument();
  });
}); 