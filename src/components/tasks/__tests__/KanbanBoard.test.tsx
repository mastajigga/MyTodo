...
describe('KanbanBoard', () => {
  ...
  it('affiche le badge Décalée si la tâche est auto-décalée', () => {
    render(<KanbanBoard tasks={[{ ...baseTask, estimated_time: 30, start_time: '2024-06-01T11:00:00.000Z' }]} />);
  ...
  it('a un aria-label sur la carte', () => {
    render(<KanbanBoard tasks={[baseTask]} />);
    const cards = screen.getAllByLabelText(/tâche/i);
